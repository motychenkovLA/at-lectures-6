...
import services.BugredController;

public class RestTest extends BaseApiTest {

    @DisplayName("Тест 1 проверка успешности регистрации")
    @Test
    ...
    @DisplayName("Тест 2 повторная регистрация")
    @Test
    ...
    @DisplayName("Тест 3 проверка что пользователь успешно зарегистрирован")
    @Test
